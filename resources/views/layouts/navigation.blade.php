            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-4">
                ...
                <div class="ml-4 flow-root lg:ml-6">
                    <a href="{{ route('cart.index') }}" class="group -m-2 flex items-center p-2">
                        ...
                        <span
                            class="ml-2 text-sm font-medium text-gray-500 group-hover:text-gray-800 dark:text-white dark:group-hover:text-gray-300">{{ $totalItems ?? 0 }}</span>
                    </a>
                </div>
                <!-- Search -->
                ...
                <div class="ml-auto flex items-center">
                    @guest
                        <div class="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                            <a href="{{ route('login') }}"
                                class="text-sm font-medium text-gray-700 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-500">Entrar</a>
                            <span class="h-6 w-px bg-gray-700 dark:bg-gray-200" aria-hidden="true"></span>
                            <a href="{{ route('register') }}"
                                class="text-sm font-medium text-gray-700 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-500">Criar
                                Conta</a>
                        </div>
                    @endguest
